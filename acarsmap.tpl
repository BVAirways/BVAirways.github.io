...
<div class="mapcenter" align="center">
	<div id="acarsmap" style="width:100%; height: <?php echo Config::Get('MAP_HEIGHT')?>"></div>
</div>
<?php
...
<td><div class="progress progress-striped">
  <div class="progress-bar progress-bar-info" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: <%=flight.percomplete%>%">
    <span class="sr-only"><%=flight.percomplete%>%</span>
  </div>
</div></td>
</tr>
</script>
...
<div style="width:220px;" class="bubble">
	<span style="font-size: 10px; text-align:left; width: 100%" align="left">
    
		<h4>Flight Information</h4>
        <hr>
        	<p> <strong>Flight:</strong> <%=flight.flightnum%> <br>
        		<strong>Origin:</strong> <%=flight.depapt%> (<%=flight.depicao%>) <br>
        		<strong>Destination:</strong> <%=flight.arrapt%> (<%=flight.arricao%>) <br>
                <strong>Status:</strong> <%=flight.phasedetail%>
            </p>
            
        <hr>
        	<p> <strong>Aircraft</strong> <%=flight.aircraftname%> <br>
            	<strong>Registration</strong> <%=flight.aircraft%> <br>
            </p>

        <hr>
        	<p> <strong>Altitude:</strong> <%=flight.alt%>ft <br>
                <strong>Ground Speed:</strong> <%=flight.gs%>kts <br>
                <strong>Heading:</strong> <%=flight.heading%> <br>
                <strong>Distance Remaining:</strong> <%=flight.distremaining%>nm<br>
                <strong>Time to Destination:</strong> <%=flight.timeremaining%>
            </p>      
    </span>
    </div>
</script>
